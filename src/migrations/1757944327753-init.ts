...
export class Init1757944327753 implements MigrationInterface {
    name = 'Init1757944327753'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "game" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "startingStatsPoints" integer DEFAULT '0', "startingMoney" double precision DEFAULT '0', "gameMasterId" uuid NOT NULL, CONSTRAINT "PK_352a30652cd352f552fef73dec5" PRIMARY KEY ("id"))`);
