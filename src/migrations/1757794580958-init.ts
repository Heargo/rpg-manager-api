...
export class Init1757794580958 implements MigrationInterface {
    name = 'Init1757794580958'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "game" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "startingStatsPoints" integer, "startingMoney" integer, "gameMasterId" uuid NOT NULL, CONSTRAINT "PK_352a30652cd352f552fef73dec5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "attribute" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "maxValue" integer NOT NULL, "gameId" uuid NOT NULL, CONSTRAINT "PK_b13fb7c5c9e9dff62b60e0de729" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "character_attribute" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "value" integer NOT NULL, "characterId" uuid NOT NULL, "attributeId" uuid NOT NULL, CONSTRAINT "PK_c645dabb88cad8b7bb2d5b843d7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "attribute" ADD CONSTRAINT "FK_4507193efa032ddc75e94c0d9b6" FOREIGN KEY ("gameId") REFERENCES "game"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
